python tf_pose/train.py --model=cmu --datapath=datasets/annotations/ --batchsize=4 --lr=0.001 --imgpath=datasets/Humane/

python tf_pose/train.py --model=cmu --datapath=/media/obasekore/Transcend1/datasets/coco/annotations/ --batchsize=10 --lr=0.0001 --imgpath=/media/obasekore/Transcend1/datasets/coco/images/
